...
PYBIND11_MODULE(spatialmp4, m) {
    ...
    py::class_<SpatialML::rgb_frame>(m, "RGBFrame")
        ...
        .def_property("left_rgb",
            [](const SpatialML::rgb_frame &f) { return mat_to_numpy(f.left_rgb); },
            [](SpatialML::rgb_frame &f, py::array_t<uint8_t> arr) {
                // TODO: implement setter if needed
            })
        .def_property("right_rgb",
            [](const SpatialML::rgb_frame &f) { return mat_to_numpy(f.right_rgb); },
            [](SpatialML::rgb_frame &f, py::array_t<uint8_t> arr) {
                // TODO: implement setter if needed
            })
    ...
    py::class_<SpatialML::depth_frame>(m, "DepthFrame")
        ...
        .def_property("depth",
            [](const SpatialML::depth_frame &f) { return depth_mat_to_numpy(f.depth); },
    ...
    py::class_<SpatialML::Reader>(m, "Reader")
        ...
        .def("load_rgb", [](SpatialML::Reader& self) {
            SpatialML::rgb_frame frame;
            self.Load(frame);
            return frame;
        })
        .def("load_depth", [](SpatialML::Reader& self) {
            SpatialML::depth_frame frame;
            self.Load(frame);
            return frame;
        })
        .def("load_both", [](SpatialML::Reader& self) {
    ...
    py::class_<SpatialML::RandomAccessVideoReader>(m, "RandomAccessVideoReader")
        ...
        .def("get_frame", [](SpatialML::RandomAccessVideoReader& self, int64_t frame_number) -> py::object {
